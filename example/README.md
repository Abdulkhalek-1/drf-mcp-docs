# drf-mcp-docs Example Project

A minimal Django project demonstrating [drf-mcp-docs](https://github.com/Abdulkhalek-1/drf-mcp-docs) with drf-spectacular.
...
> **Local development:** If you're working from the drf-mcp-docs repo, install the package in editable mode instead:
> ```bash
...
See the [full configuration reference](https://abdulkhalek-1.github.io/drf-mcp-docs/configuration/) for all available settings.
